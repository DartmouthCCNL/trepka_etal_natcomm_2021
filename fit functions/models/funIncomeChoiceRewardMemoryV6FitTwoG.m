function [negloglike, nlls]=funIncomeChoiceRewardMemoryV6FitTwoG(xpar,dat)
% % funDQ_RPE %
...
for k=1:nt
    ...
    c_right = update(c_right, gamma1, dat(k,1)==1);
    c_left = update(c_left, gamma1, dat(k,1)==-1);
    erpe = update(erpe, gamma2, abs(rpe));
